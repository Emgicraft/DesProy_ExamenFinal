...
class Ui_SisDomArduino(object):
    def setupUi(self, SisDomArduino):
        ...
        self.titulo04.setEnabled(False)
        ...
        self.bLed2On.setGeometry(QtCore.QRect(310, 140, 110, 30))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.bLed2On.setToolTip("Controla Led 02")
        ...
        self.bLed2On.setText("Led 02 On/Off")
        ...
        SisDomArduino.setTabOrder(self.bLed1, self.bLed2On)
        SisDomArduino.setTabOrder(self.bLed2On, self.bLed3)
